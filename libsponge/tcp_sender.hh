...
class TCPSender {
  private:
    ...
    // Keep track of which segments have been sent 
    ...
    size_t _retransmissionTimeout = 0;

    size_t _consecutiveRetransmission = 0;
  ...
  public:
    ...
    void fill_window(bool is_able_to_send_syn = true);
